...
{
    public partial class UpdateCoverTypeWithProcedure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    Name = table.Column<string>("nvarchar(60)", maxLength: 60, nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => { table.PrimaryKey("PK_CoverTypes", x => x.Id); });
